...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.part1_container}>
      ...
      <section className={styles.part3_container}>
      ...
      <section id='youtube' className={styles.youtube}>
        <div className={styles.header}>
          <span className={styles.topic}>
            Youtube channels
          </span>
      ...
      <section id='donation' className={styles.donations}>
        <div className={styles.header}>
          <span className={styles.topic}>
            Donations & Campaigns
          </span>
